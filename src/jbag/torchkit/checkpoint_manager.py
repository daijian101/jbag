...
class CheckpointManager:
    ...
    @classmethod
    def save_checkpoint(cls, output_file: str, model: nn.Module, optimizer: Optimizer | None = None,
                        **kwargs):
    ...
    @classmethod
    def load_checkpoint(cls, checkpoint_file: str, model: nn.Module | None= None,
